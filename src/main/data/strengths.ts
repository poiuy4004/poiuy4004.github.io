...
export const testimonials: Testimonial[] = [
  ...
  {
    quote: "끊임없이 지식을 갈구하시는 모습이 좋았습니다.",
    author: "부트캠프 동기",
  },
  {
    quote:
      "저희 조가 순항할 수 있었던 데에는 용민님이 프론트엔드 파트의 한 축을 담당하시면서 요구 사항을 더 나은 방향으로 발전시켜 진행했던 것이 주효했다고 생각합니다.",
    author: "부트캠프 동기",
  },
  {
    quote: "문제 해결 과정에서 적극적인 자세로 끝까지 해결해 나가는 모습이 멋졌습니다.",
    author: "부트캠프 동기",
  },
];
